...
/**
 * Bidirectional WebSocket messaging service supporting both sending and receiving. Manages multiple
 * client connections and provides reactive message handling via RxJava.
 */
@Service
