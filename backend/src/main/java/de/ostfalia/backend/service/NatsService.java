...
/**
 * Bidirectional NATS messaging service supporting both publishing and subscribing. Connects to NATS
 * server and provides reactive message handling via RxJava.
 */
@Service
